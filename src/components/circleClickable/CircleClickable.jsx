...
const CircleClickable = () => {
    ...
    const handleLit = (n) => {
        var temp = n.slice(3, 4)
        if (lit.[n] === false) {
            setLit({ ...lit, [n]: true })
        }
        else if (lit.[n] === true) {
            var boolItem = 'bool' + temp
            setLit({ ...lit, [n]: false });
            setBool({ ...bool, [boolItem]: true })
        }
    };

    const handleBroken = (b) => {
    ...
    return (
		...
		S133.5,165.2,94.4,165.2z"/>
                ...
                <g id="indicators_broken">
                    <a href="#" onClick={() => handleBroken('bool1')}>
			...
			17.1,63.2 19.9,60.3 22.8,63.1 		"/>
                    ...
                    <a href="#" onClick={() => handleBroken('bool2')}>
			...
			59.1,22.2 61.9,19.3 64.8,22.1 		"/>
                    ...
                    <a href="#" onClick={() => handleBroken('bool3')}>
			...
			128.5,20.3 127.7,21.1 124.9,18.3 		"/>
                    ...
                    <a href="#" onClick={() => handleBroken('bool4')}>
			...
			167.5,64.8 170.3,61.9 173.2,64.7 		"/>
                    ...
                    <a href="#" onClick={() => handleBroken('bool5')}>
			...
			167.7,126.9 168.5,127.7 171.4,124.8 174.2,127.7 		"/>
                    ...
                    <a href="#" onClick={() => handleBroken('bool6')}>
			...
			124.2,172.4 125,173.2 127.8,170.3 130.7,173.1 		"/>
                    ...
                    <a href="#" onClick={() => handleBroken('bool7')}>
			...
			61.1,174.2 63.9,171.3 66.8,174.1 		"/>
                    ...
                    <a href="#" onClick={() => handleBroken('bool8')}>
