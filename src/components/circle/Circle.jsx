...
const Circle = (props) => {
    ...
    const {text, brokenCounter} = props;
...
const setBrokenIndicator = () => {
    for (let i = 0; i < brokenCounter; i++) {
        console.log(brokenCounter)
        setBool([...bool, bool[i]=true]);
    }
    console.log('1',bool[0])
    console.log('2',bool[1])
    console.log('3',bool[2])
}
...
console.log(bool)
    ...
    return (
		...
		S133.5,165.2,94.4,165.2z"/>
                ...
                <g id="indicators">
                    <path id="indicator1" className="unlit" d="M38.2,40.7C25.4,54.1,17.3,72.3,16.6,92.2H6.5c0.6-22.8,10-43.7,24.8-58.9L38.2,40.7z" />
                    <path id="indicator2" className="unlit" d="M92,16.8c-18.4,0.5-36.1,7.5-50.5,21l-7.2-7.2C50.7,15.2,71,7.2,91.9,6.7L92,16.8z" />
                    <path id="indicator3" className="unlit" d="M148.1,37.9c-13.4-12.7-32.6-20.7-51.6-21.3V6.5c22,0.6,43.6,9.7,58.8,24.2L148.1,37.9z" />
                    <path id="indicator4" className="unlit" d="M172.2,92.1c-0.5-18.4-8.4-37.8-21.4-51.7l7.1-7.2c15.1,16,23.9,37.9,24.5,58.8L172.2,92.1z" />                  
                    <path id="indicator5" className="unlit" d="M158.6,154.5c14.5-15.4,23.3-35.6,23.7-58.3l-10.2-0.1c-0.4,19.8-8.3,37.9-20.9,51.4L158.6,154.5z" />
                    <path id="indicator6" className="unlit" d="M96.2,171.4c18-0.5,37.9-7.5,52.4-21.5l7.1,7.3c-16.4,15.9-38.3,23.5-59.3,24.1L96.2,171.4z" />
                    <path id="indicator7" className="unlit" d="M40.9,149.8c13.6,12.9,30.9,21.1,51.1,21.6l0.1,9.9c-22.9-0.4-42.6-9.3-58-24L40.9,149.8z" />
                    <path id="indicator8" className="unlit" d="M16.6,96.2c0.4,20,8.4,37.8,21.1,51.4l-7.3,7.1C15.9,139.3,6.9,119,6.5,96.2L16.6,96.2z" />
                </g>

                {/* BROKEN INDICATORS */}
                <g id="indicators_broken">
                <g id="broken1" className={bool[0] ? 'on' : 'off'}>
			...
			17.1,63.2 19.9,60.3 22.8,63.1 		"/>
                    ...
                    <g id="broken2" className={bool[1] ? 'on' : 'off'}>
			...
			59.1,22.2 61.9,19.3 64.8,22.1 		"/>
                    ...
                    <g id="broken3" className={bool[2] ? 'on' : 'off'}>
